...
var builderUQTQueryMsg = function(UQTQueryMsg) {
	...
	$.each(UQTQueryMsg, function(i, eachData) {
		...
		tr.append("<td class='eng_name'>" + listContact + "</td>" +
			...
			"<td class='dis_dta'>" +
			"<a class='editOp' href='' data-toggle='modal' data-target='#employer' onclick='updateEmployer(this)'>修改</a>" +
			"<a class='editOp' href='javascript:void(0);' onclick='deleteEmployer(this)'>删除</a>" +
			"</td>" +
