...
/**
 * VOrderTraineeLinkId entity. @author MyEclipse Persistence Tools
 */

public class VOrderTraineeLinkId implements java.io.Serializable {
	...
	/** default constructor */
	public VOrderTraineeLinkId() {
	}

	/** minimal constructor */
	public VOrderTraineeLinkId(Long id, Long orderId, Long traineeId) {
		this.id = id;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VOrderTraineeLinkId))
			return false;
		VOrderTraineeLinkId castOther = (VOrderTraineeLinkId) other;
